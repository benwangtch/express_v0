...
function parseResponse(groupData, response) {
    ...
    var renderFeatures = ['addr', 'far', 'house_age', '土地移轉總面積(坪)', '建物移轉總面積(坪)', 'population_density', '主建物面積', 'n_c_1000', 'price_pin']
    var outputGroupData = [
        ['地址', '容積率', '屋齡', '土地移轉總面積(坪)', '建物移轉總面積(坪)', 'population_density', '主建物面積', 'YIMBY_1000', 'price_pin'],
